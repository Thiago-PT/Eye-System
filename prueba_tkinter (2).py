...
# Funciones para los efectos visuales en los botones
...
def abrir_ventana_principal():
    ...
    button_camera = crear_boton(root, "Iniciar Reconocimiento", iniciar_rec)
...
ventana_bienvenida.geometry("1000x550")
